...
) A ) userProfile, pergunta p where lower(userProfile.surface) = 'aerobic respiration'
...
) A ) userProfile, resposta p where lower(userProfile.surface) = 'aerobic respiration'
		and p.id = userProfile.idText