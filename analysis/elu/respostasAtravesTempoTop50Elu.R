...
dadosComunidade <- subset(dadosParticipacaoGeral, dadosParticipacaoGeral$comunidade == 'ELU')
...
dadosRespostasComunidade <- subset(dadosRespostas, dadosRespostas$comunidade == 'ELU' & dadosRespostas$anoCriacao >= 2012)
