...
tabelaSpearman['BIO', "correlation"] <- cor(dadosBioTop$reputacao, dadosBioTop$perguntas, method = "spearman")
tabelaSpearman['BIO', "p-value"] <- cor.test(dadosBioTop$reputacao, dadosBioTop$perguntas, method = "spearman")$p.value

tabelaKendall['BIO', "method"] <- "kendall"
tabelaKendall['BIO', "correlation"] <- cor(dadosBioTop$reputacao, dadosBioTop$perguntas, method = "kendall")
tabelaKendall['BIO', "p-value"] <- cor.test(dadosBioTop$reputacao, dadosBioTop$perguntas, method = "kendall")$p.value


tabelaSpearman['TA', "method"] <- "spearman"
tabelaSpearman['TA', "correlation"] <- cor(dadosTaTop$reputacao, dadosTaTop$perguntas, method = "spearman")
tabelaSpearman['TA', "p-value"] <- cor.test(dadosTaTop$reputacao, dadosTaTop$perguntas, method = "spearman")$p.value

tabelaKendall['TA', "method"] <- "kendall"
tabelaKendall['TA', "correlation"] <- cor(dadosTaTop$reputacao, dadosTaTop$perguntas, method = "kendall")
tabelaKendall['TA', "p-value"] <- cor.test(dadosTaTop$reputacao, dadosTaTop$perguntas, method = "kendall")$p.value


tabelaSpearman['FIS', "method"] <- "spearman"
tabelaSpearman['FIS', "correlation"] <- cor(dadosFisTop$reputacao, dadosFisTop$perguntas, method = "spearman")
tabelaSpearman['FIS', "p-value"] <- cor.test(dadosFisTop$reputacao, dadosFisTop$perguntas, method = "spearman")$p.value

tabelaKendall['FIS', "method"] <- "kendall"
tabelaKendall['FIS', "correlation"] <- cor(dadosFisTop$reputacao, dadosFisTop$perguntas, method = "kendall")
tabelaKendall['FIS', "p-value"] <- cor.test(dadosFisTop$reputacao, dadosFisTop$perguntas, method = "kendall")$p.value

tabelaSpearman['ELU', "method"] <- "spearman"
tabelaSpearman['ELU', "correlation"] <- cor(dadosEluTop$reputacao, dadosEluTop$perguntas, method = "spearman")
tabelaSpearman['ELU', "p-value"] <- cor.test(dadosEluTop$reputacao, dadosEluTop$perguntas, method = "spearman")$p.value

tabelaKendall['ELU', "method"] <- "kendall"
tabelaKendall['ELU', "correlation"] <- cor(dadosEluTop$reputacao, dadosEluTop$perguntas, method = "kendall")
tabelaKendall['ELU', "p-value"] <- cor.test(dadosEluTop$reputacao, dadosEluTop$perguntas, method = "kendall")$p.value
...
print('Correlacao Top 50 - Reputacao X Perguntas')
print(tabelaSpearman)
print(tabelaKendall)
options(scipen=999)
write.table(tabelaSpearman, file = "correlacaoTop50PerguntasReputacaoSpearman", sep = ";")
write.table(tabelaKendall, file = "correlacaoTop50PerguntasReputacaoKendall", sep = ";")
