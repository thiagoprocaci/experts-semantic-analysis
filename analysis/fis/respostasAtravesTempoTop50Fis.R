...
dadosRespostas = read.csv("C:\\Users\\thiag_000\\Desktop\\analises\\respostasComunidades.csv", header = TRUE, sep = ';')

dadosComunidade <- subset(dadosParticipacaoGeral, dadosParticipacaoGeral$comunidade == 'FIS')
...
dadosRespostasComunidade <- subset(dadosRespostas, dadosRespostas$comunidade == 'FIS' & dadosRespostas$anoCriacao >= 2012)
