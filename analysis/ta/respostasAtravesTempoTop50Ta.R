...
dadosComunidade <- subset(dadosParticipacaoGeral, dadosParticipacaoGeral$comunidade == 'TA')
...
dadosRespostasComunidade <- subset(dadosRespostas, dadosRespostas$comunidade == 'TA' & dadosRespostas$anoCriacao >= 2012)
